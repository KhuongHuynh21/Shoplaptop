...
<div class="register-account ptb-100 ptb-sm-60">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="form-register" method="POST" action="{{route('dangky')}}">
                    @csrf
                    <fieldset>
                        ...
                        <div class="form-group d-md-flex align-items-md-center">
                            ...
                            <div class="col-md-10">
                                <input type="number" class="form-control" id="phone" name="phone" placeholder="{{trans('home.phone')}}">
                            </div>
                        </div>
                        <div class="form-group d-md-flex align-items-md-center">
                     ...
                     <fieldset>
                        ...
                        <div class="form-group d-md-flex align-items-md-center">
                            ...
                            <input class="form-control" name="password" id="password" required
                                    title="(Gồm các ký tự chữ thường, in hoa hoặc số, có chứa tối thiểu 1 ký tự thường, 1 ký tự in hoa và 1 ký tự số, từ 6-32 ký tự)"
                                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,32}" type="password"
